...
\begin{tikzpicture}
    ...
    %draw poles
    \node[solid, cross out,draw=black] at (0.5,1.5) {};
    \node at (0.8,1.2) {\textcolor{black}{$w_1$}};
    \node[solid, cross out,draw=black] at (1.3,0.7) {};
    \node at (1.6,0.4) {\textcolor{black}{$w_2$}};
    \node[solid, cross out,draw=black] at (1.3,-1.3) {};
    \node at (1.6,-1.6) {\textcolor{black}{$w_3$}};
    \node[solid, cross out,draw=black] at (-1.8,1.2) {};
    \node at (-1.5,0.9) {\textcolor{black}{$w_4$}};
    \node[solid, cross out,draw=black] at (0,0) {};
    \node at (0.3,-0.3) {\textcolor{black}{$w_{\infty}$}};
    \end{scope}
\end{tikzpicture}
\end{document}