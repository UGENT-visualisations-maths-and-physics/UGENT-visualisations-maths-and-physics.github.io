...
\begin{document}
  ...
  \begin{scope}
      ...
      \node at (0.7,1) [draw=white, inner sep=0, fill=white, shape=ellipse] {\textcolor{black!60!green}{$B(0,|z_0|)$}};
  \end{scope}
  ...
  \begin{scope}[xshift=10cm]
      ...
      % labels
      % \draw (2, 2) node[below right] {\textcolor{red}{$|z| = z_0$}};
      \node at (-2.5,2.5) [draw=white, inner sep=0, fill=white] {\textcolor{black!60!green}{$co \overline{B(0,|z_0|)}$}};
      
      \node at (2.45,2.10) [draw=white, inner sep=0, fill=white, shape=ellipse] {\textcolor{red}{$|z| = z_0$}};
