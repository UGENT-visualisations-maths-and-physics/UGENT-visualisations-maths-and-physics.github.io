...
\begin{tikzpicture}
 ...
 -- (\ang:\E) coordinate (R);
    ...
    \draw[rvec] (O) -- ($(R)+(\ang:-0.05)$) node[pos=0.7,below=0] {$\vb{r}$};
    \draw[force] ($(R)+(0.09,0)$) --++ (0.6*\E,0) node[right] {$\vb{F}_\mathrm{cf}$};
    ...
    \node[gcol,above right=2pt] at ($(R)+(-0.25,0)$) {$\vb*{\omega} \times \vb{r}$};
