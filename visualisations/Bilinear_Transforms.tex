...
\begin{tikzpicture}
    ...
    \draw[->, thick, bend left=15] (-4,9) to node[midway, above] {$w_1 = z-1$} (-2,9);
    ...
    \draw[->, thick, bend left=15] (4,9) to node[midway, above] {$w_2 = \frac{1}{w_1}$} (6,9);
    ...
    \draw[->, thick, bend left=15] (9,5.5) to node[midway, right] {$w_3 = \mathrm{e}^{i\frac{\pi}{4}} w_2$} (9,3.5);
    ...
    \draw[->, thick, bend right=15] (6,1) to node[midway, above] {$w_4 = \sqrt{2}\,w_3$} (4,1);
    ...
    % Arrow from 4th to 5th
    \draw[->, thick, bend right=15] (-2,1) to node[midway, above] {$w_5 = 1+w_4$} (-4,1);
