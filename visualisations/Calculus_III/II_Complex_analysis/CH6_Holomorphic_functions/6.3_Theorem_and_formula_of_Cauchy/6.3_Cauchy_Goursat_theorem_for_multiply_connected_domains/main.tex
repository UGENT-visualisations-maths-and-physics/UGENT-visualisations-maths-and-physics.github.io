...
\begin{tikzpicture}
    ...
    \begin{scope}
        ...
        \fill[pattern={Lines[angle=30, distance=0.4cm, line width=0.6pt]}, pattern color=gray] (Od) to[closed, curve through ={(20d) (40d) (55d) (80d) (110d)  (300d) }] (330d);
        \fill[white] (bLocation) circle [radius=0.5];
        \fill[white] (cLocation) circle [radius=0.5];
    \end{scope}
    \node [CircleNodeStyle, label=above:$z_2$] at (bLocation) {};
    \node [CircleNodeStyle, label=above:$z_3$] at (cLocation) {};
    ...
    [postaction={decorate}, decoration={
           markings,
           mark=at position 0.25 with {\node[draw=white, ellipse, inner sep=0, fill=white, name=EndVectorNode, above=0.02cm] {$\partial B(z_1,\epsilon)$};},    % ensure node has a white background
    ...
    [postaction={decorate}, decoration={
           markings,
           mark=at position 0.25 with {\node[draw=white, ellipse, inner sep=0, fill=white, name=EndVectorNode, above=0.02cm] {$\partial B(z_2,\epsilon)$};},    % ensure node has a white background
           mark=at position 0.95 with {\node[name=EndVectorNode] {};}}]
    ...
    [postaction={decorate}, decoration={
           markings,
           mark=at position 0.25 with {\node[draw=white, ellipse, inner sep=0, fill=white, name=EndVectorNode, above=0.02cm] {$\partial B(z_3,\epsilon)$};},    % ensure node has a white background
           mark=at position 0.95 with {\node[name=EndVectorNode] {};}}]
