...
\caption{Rate change of a vector $\vec{G}$, as perceived by an observer in the fixed body frame: $d \vec{G}_{body}$ (right) and in the space frame: $d \vec{G}_{space} = d \vec{G}_{body} + \pmb{\omega} \times \vec{G}$ (left). The $z'$ axis is chosen such that it aligns with $\pmb{\omega}$.}
\end{figure}
...
\subsection*{4.10.3 centrifugal force}
\begin{figure}[H]
\centering
\includegraphics{CH4/4.10_The_Coriolis_effect/4.10.3_centrifugal_force/standalone.pdf}
\caption{}
\end{figure}

\subsection*{4.10.3 coriolis sphere sol}
\begin{figure}[H]
\centering
\includegraphics{CH4/4.10_Z_exercises_session/4.10.3_coriolis_sphere_sol/standalone.pdf}
\caption{}
\end{figure}

\subsection*{4.10.3 coriolis sphere task}
\begin{figure}[H]
\centering
\includegraphics{CH4/4.10_Z_exercises_session/4.10.3_coriolis_sphere_task/standalone.pdf}
\caption{}
\end{figure}

\subsection*{4.10.4 coriolis local task}
\begin{figure}[H]
\centering
\includegraphics{CH4/4.10_Z_exercises_session/4.10.4_coriolis_local_task/standalone.pdf}
\caption{}
\end{figure}

\subsection*{4.10.4 coriolis local sol}
\begin{figure}[H]
\centering
\includegraphics{CH4/4.10_Z_exercises_session/4.10.4_coriolis_local_sol/standalone.pdf}
\caption{}
\end{figure}

\subsection*{4.10.4.1 coriolis forces northern hemisphere}
\begin{figure}[H]
\centering
\includegraphics{CH4/4.10_The_Coriolis_effect/4.10.4.1_coriolis_forces_northern_hemisphere/standalone.pdf}
\caption{}
\end{figure}

\subsection*{4.10.4.2 coriolis forces northern hemisphere}
\begin{figure}[H]
\centering
\includegraphics{CH4/4.10_The_Coriolis_effect/4.10.4.2_coriolis_forces_northern_hemisphere/standalone.pdf}
\caption{}
\end{figure}

\subsection*{4.10.5 Deflection Angle task}
\begin{figure}[H]
\centering
\includegraphics{CH4/4.10_Z_exercises_session/4.10.5_Deflection_Angle_task/standalone.pdf}
\caption{}
\end{figure}

\subsection*{4.10.5 Deflection Angle sol}
\begin{figure}[H]
\centering
\includegraphics{CH4/4.10_Z_exercises_session/4.10.5_Deflection_Angle_sol/standalone.pdf}
\caption{}
\end{figure}

\subsection*{4.10.5.1 coriolis forces southern hemisphere}
\begin{figure}[H]
\centering
\includegraphics{CH4/4.10_The_Coriolis_effect/4.10.5.1_coriolis_forces_southern_hemisphere/standalone.pdf}
\caption{}
\end{figure}

\subsection*{4.10.5.2 coriolis forces southern hemisphere}
\begin{figure}[H]
\centering
\includegraphics{CH4/4.10_The_Coriolis_effect/4.10.5.2_coriolis_forces_southern_hemisphere/standalone.pdf}
\caption{}
\end{figure}

\subsection*{4.10.6 coriolis effect vortex}
\begin{figure}[H]
\centering
\includegraphics{CH4/4.10_The_Coriolis_effect/4.10.6_coriolis_effect_vortex/standalone.pdf}
\caption{}
\end{figure}

\subsection*{4.10.7.1 coriolis NH vertical velocity}
\begin{figure}[H]
\centering
\includegraphics{CH4/4.10_The_Coriolis_effect/4.10.7.1_coriolis_NH_vertical_velocity/standalone.pdf}
\caption{}
\end{figure}

\subsection*{4.10.7.2 coriolis NH vertical velocity}
\begin{figure}[H]
\centering
\includegraphics{CH4/4.10_The_Coriolis_effect/4.10.7.2_coriolis_NH_vertical_velocity/standalone.pdf}
\caption{}
\end{figure}

\subsection*{4.10.8.1 coriolis SH vertical velocity}
\begin{figure}[H]
\centering
\includegraphics{CH4/4.10_The_Coriolis_effect/4.10.8.1_coriolis_SH_vertical_velocity/standalone.pdf}
\caption{}
\end{figure}

\subsection*{4.10.8.2 coriolis SH vertical velocity}
\begin{figure}[H]
\centering
\includegraphics{CH4/4.10_The_Coriolis_effect/4.10.8.2_coriolis_SH_vertical_velocity/standalone.pdf}
\caption{}
\end{figure}
...
\caption{Graphical representation of the relationship between the angular velocity vector $\pmb{\omega}$ (gray) and the angular momentum vector $\pmb{L}$ (red) for a rectangular beam with inertia tensor $\mathbf{I}$. 
The directions of $\pmb{L}$ and $\pmb{\omega}$ do not coincide due to the anisotropy of the inertia tensor. 
...
\caption{Graphical representation of the relationship between the angular velocity vector $\pmb{\omega}$ (gray) and the angular momentum vector $\pmb{L}$ (red) for an ellipsoid with inertia tensor $\mathbf{I}$. 
The directions of $\pmb{L}$ and $\pmb{\omega}$ do not coincide due to the anisotropy of the inertia tensor. 
