...
\begin{tikzpicture}
    ...
    \draw[red,domain=-1.6:1.6,samples=50, line width=1] plot ({\x},catenaryY{\x}) node[right] {$P(x)$};

    \draw[blue,domain=-4:4,samples=50, line width=1] plot (tractrixX{\x},tractrixY{\x}) node[above] {$Q(x)$};
