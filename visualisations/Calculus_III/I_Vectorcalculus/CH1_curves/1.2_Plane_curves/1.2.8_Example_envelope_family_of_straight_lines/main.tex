...
\begin{tikzpicture}
    ...
    \draw[blue,domain=-1:1,samples=200, line width=1, smooth] plot ({\x},{-(1-\x^(2/3))^(3/2)});
    
    \draw[red,domain=-1.2:2, samples=200, line width=1, smooth] plot ({\x}, {(1-\x/cos(pi/3 r))*sin(pi/3 r)});
    \node[anchor=west] at (1.8,-2.1) {\textcolor{red}{$F(x,y, \frac{\pi}{3})$}};

    \draw[black!60!green,domain=-2:2.5, samples=200, line width=1, smoothCa] plot ({\x}, {(1-\x/cos(pi/5 r))*sin(pi/5 r)});
