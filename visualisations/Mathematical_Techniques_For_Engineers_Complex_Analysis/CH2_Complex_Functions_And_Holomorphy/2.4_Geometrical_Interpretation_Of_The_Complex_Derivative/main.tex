...
\node at ($ (HighlightedCoord) + (-0.45, 0.20) $) {$f(x_{0}, y_{0})$}; 
...
\path[name path=YAxisProjection] (SurfaceLowerProjected) -- ($(SurfaceLowerProjected)!5!(SurfaceUpperProjected)$);
\path[name path=XAxisProjection] (SurfaceRightProjected) -- ($(SurfaceRightProjected)!5!(SurfaceLeftProjected)$);
...
% Labels
\node[draw=white, ellipse, inner sep=0, fill=white] at ($ (FunctionCoord) + (-0.075, -0.15) $) {\scriptsize $g(x,y)$};
